// Content script: finds posts in the LinkedIn feed, asks the service worker to classify them,
// and paints a colored box + label on each one.
(() => {
  const BATCH_SIZE = 8; // posts are long; 8 keeps a request comfortably small
