...
Upload `dist/jevedin-<version>.zip` (build it with `./scripts/package.sh`) at
https://chrome.google.com/webstore/devconsole, then paste the fields below.

## Store listing

**Name** (comes from the manifest): JevedIn: Cut the Slop from LinkedIn
...
Your LinkedIn feed is full of "Agree?", "humbled and honored to announce" and AI-written listicles. JevedIn puts a colored box around every post and tells you what it really is, so you can skip straight to the posts worth reading.
...
Powered by Jev, a fast decision model from TypeSafe AI. JevedIn is an independent tool and is not affiliated with or endorsed by LinkedIn.
...
**Privacy policy URL:** https://jev-backend.vercel.app/jevedin/privacy.html
